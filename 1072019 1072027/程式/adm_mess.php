...
<head>
	...
	<style>
		* {
		...
		.top{
			/*box-shadow: 0px 0px 5px 5px rgba(250,250,250,0.7);*/
			margin-bottom: 20px;
...
<body>
	...
	<div class="container border border-secondary rounded top">
		...
		<div class="row">
			<div class="col-sm text-right" style="padding: 12px 15px">
				...
				<? echo "<a class='btn btn-outline-success' href='evaluation_more.php?class={$Subject}' role='button'>看更多評價</a>" ?>
			</div>
		</div>
	</div>
	...
	<div class="container border border-secondary rounded top">
		...
		<div class="row">
			<div class="col-sm text-right" style="padding: 12px 15px">
				<a class="delete btn btn-outline-warning" href="delete_mess.php" role="button">刪除留言</a>
